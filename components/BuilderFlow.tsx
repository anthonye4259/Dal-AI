...
const STEPS = [
    ...
    { title: 'Logo & Icon', icon: Sparkles, description: 'Upload your visual assets' },
    { title: 'Color Theme', icon: Palette, description: 'Define your brand colors' },
    { title: 'Launch Config', icon: Settings, description: 'Configure splash & loaders' },
    { title: 'Home Screen', icon: Layout, description: 'Customize hero & widgets' },
    { title: 'Navigation', icon: Grid, description: 'Choose your main tabs' },
    { title: 'Classes', icon: Globe, description: 'Add your first schedule items' },
    { title: 'Features', icon: Star, description: 'Enable advanced features' },
    { title: 'Preview', icon: Smartphone, description: 'See it in action' },
    { title: 'Launch', icon: Play, description: 'Publish your app' }
];
...
export default function BuilderFlow() {
    ...
    const STEPS = ['Studio', 'Magic Build', 'Theme', 'Brand', 'Home Screen', 'Navigation', 'Classes', 'Features', 'Preview', 'Launch'];
...
`}>
    ...
    const canProceed = () => {
        switch (currentStep) {
            ...
            case 4: return true; // Home Screen (Widgets/Hero)
            case 5: return selectedTabs.length >= 3 && selectedTabs.length <= 5; // Navigation
            case 6: return classes.length > 0; // Classes
            case 7: return true; // Features
            case 8: return true; // Preview
    ...
    const handleLaunch = async () => {
        ...
        try {
            ...
            // 1. Save to Firebase
            const leadId = await saveAppConfig(config);
            console.log("Lead saved:", leadId);

            // 2. Save local for checkout fallback
